...
{
    // Initialization
    // auto anchors = m_arap.m_shape.getAnchors();
    // if (!m_leftCapture && settings.pre_anchors != anchors)
    // {
    //     m_arap.init_system(m_arap.m_shape.getVertices(), anchors);
    //     settings.pre_anchors = anchors;
    // }
